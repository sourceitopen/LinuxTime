...
grails.project.groupId = com.linuxtime // change this to alter the default package name and Maven publishing destination
...
grails.plugins.springsecurity.userLookup.userDomainClassName = 'com.linuxtime.User'
