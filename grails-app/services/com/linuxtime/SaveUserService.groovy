...
def saveUser(def receivedParams){
	...
	def user = new User(username:receivedParams.userName,password:receivedParams.password,country:receivedParams.country,enabled:true,accountExpired:false,accountLocked:false,passwordExpired:false)
	if(user.validate())
	{
